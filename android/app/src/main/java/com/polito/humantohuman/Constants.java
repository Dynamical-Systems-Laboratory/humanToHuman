...
public class Constants {
  ...
  public static class TIME {
    ...
    /**
     * MAX_TIME_BT_DISCOVERY = How much time should be the device in
     * discoverable mode
     */
    public static final int MAX_TIME_BT_DISCOVERY = 3600;
    /**
     * NOTIFY_INTERVAL = The interval of time where the service for start the
     * scanning service should be called
     */
    public static final long NOTIFY_INTERVAL =
        1000 * (VERSION >= Build.VERSION_CODES.N ? 20 : 30);
    /**
     * NOTIFY_INTERNET_INTERVAL = The interval of time where the alarm for the
     * uploadservice should be called
     */
     ...
     */
    // public static final long MAX_TIME_BT_SCAN = VERSION >=
    // Build.VERSION_CODES.N ? MAX_TIME_BLE_SCAN : 40000 ;
    ...
    /**
     * MAX_TIME_UPLOAD = Value that will determine if the application should
     * upload local information or not
     */
    public static final long MAX_TIME_UPLOAD = 100 * 1000;
    /**
     * SEND_SAVE_DATA_THREAD_TIME = The time that the handler should wait before
     * uploading another object from the local database
     */
    public static final long SEND_SAVE_DATA_THREAD_TIME = 2000;
    /**
     * TIME_OUT = How much time should pass before consider that we haven't
     * received a response from the server
     */
    public static final int TIME_OUT = 3000;
    /**
     * RESPONSE_TIME_OUT = How much time should pass before consider that we
     * haven't received a response from the server
     */
    ...
    /**
     * MAX_TIME_LOCALIZATION = This value will determine how much time should
     * pass before updating the localization
     */
  ...
  /**
   * Class that will store the possible actions that could be execute on the
   * service
   */
  ...
  // public static String CONN_INFO_ENDPOINT =
  // "http://192.168.1.104:5000/conn_info"; public static String
  // CONN_INFO_ENDPOINT = "http://192.168.1.104/conn_info";
  ...
  public static class Permissions {
     ...
     * @param context
     * @param pString Manifest string that will check if it hsa been accepted or
     *     not
     * @return
     */
    ...
    public static void requestPermissions(Activity activity) {
      ...
      ActivityCompat.requestPermissions(activity, arrayP,
    ...
    public static void setPermission(Context context, Permission p) {
      p.setAccepted(ContextCompat.checkSelfPermission(
                        context, p.getPermission()) == pCheck);
    }
    /**
