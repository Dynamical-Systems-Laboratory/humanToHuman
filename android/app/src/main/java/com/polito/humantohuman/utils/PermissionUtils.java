...
public abstract class PermissionUtils {
  ...
  public static void requestPermission(AppCompatActivity activity,
                                       int requestId, String permission,
  ...
  public static class PermissionDeniedDialog extends DialogFragment {
    ...
    /**
     * Creates a new instance of this dialog and optionally finishes the calling
     * Activity when the 'Ok' button is clicked.
     */
  ...
  public static class RationaleDialog extends DialogFragment {
    ...
    private static final String ARGUMENT_PERMISSION_REQUEST_CODE =
        "requestCode";
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
      ...
      return new AlertDialog.Builder(getActivity())
          .setMessage("need location permissions to use bluetooth properly")
          .setPositiveButton(
              android.R.string.ok,
